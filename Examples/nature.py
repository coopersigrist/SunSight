...
# plot_projections(projections, objective="Carbon Offset", save_dir_prefix="../", save_name='CarbonOffset_2mil')
# plot_projections(projections, objective="Energy Potential", save_dir_prefix="../", save_name='EnergyPot_2mil')
...
# plot_state_map(state_df, key='carbon_offset_metric_tons_per_panel', fill_color='Blues', legend_name="Carbon Offset Metric Tons Per Panel", save_dir_prefix="../Visualization/", show=False)
...
geo_plot(zips_df['carbon_offset_metric_tons_per_panel'], 'mint_r', "Carbon Offset Per Panel", pos_df, save_dir_prefix="../Visualization/")
