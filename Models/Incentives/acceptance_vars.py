...
def payback_period_of_energy_savings(max_payback, real_discount_rate, investment, income, energy_burden, proportion_offset):
    ...
    if investment/income <= energy_burden:
        ...
        return remaining_investment/yearly_payment_to_investment
...
def get_payment_stats(max_payback, installation_cost, income, energy_burden, proportion_offset):
    '''
    inputs:
...
''
def payback_period_of_energy_savings(max_payback, installation_cost, income, energy_burden, proportion_offset, interest_rate=0.0):
