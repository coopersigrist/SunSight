...
df = grid_search(combined_df, npanels=10000, metrics = metrics, objectives = objectives)
print(df)
pareto_set = pareto_calc(df)
print(pareto_set)
# print(pd.read_csv("/Users/mimilertsaroj/Desktop/SunSight/Visualization/Projection_Data/GSParetoOptSoln5"))
